...
const navLinks = [
  { label: "How It Works", href: "/#how-it-works", sectionId: "how-it-works" },
  {
    ...
    children: [
      ...
      { label: "Dissertations & Theses", href: "/services/dissertations" },
      { label: "Copywriting",            href: "/services/copywriting" },
      { label: "Proofreading & Editing", href: "/services/proofreading-editing" },
      { label: "Blog & SEO Content",     href: "/services/blog-seo-content" },
      { label: "Business Writing",       href: "/services/business-writing" },
      { label: "Case Studies",           href: "/services/case-studies" },
      { label: "Lab Reports & STEM",     href: "/services/lab-reports" },
      { label: "Presentations",          href: "/services/presentations" },
      { label: "CVs & Cover Letters",    href: "/services/cv-resume" },
